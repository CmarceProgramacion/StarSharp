...
public class MeetingPage extends PageObject {
    ...
    public static final Target INPUT_MEETING_TYPE = Target.the("Text field to enter in meeting type ").locatedBy("//input[@id='s2id_autogen76_search']");
    ...
    public static final Target LIST_START_TIME = Target.the("Drop-down list of start time").located(By.name("//select[@class='editor s-DateTimeEditor time valid']"));
    public static final Target LIST_END_TIME = Target.the("Drop-down list of time end date").located(By.name("//select[@class='editor s-DateTimeEditor time']"));
    ...
    public static final Target INPUT_LOCATION = Target.the("").locatedBy("//label[text()='Location']//following-sibling::input[@class='select2-input']");

    public static final Target SELECT_UNIT = Target.the("").locatedBy("(//label[@title='Unit']//following::span[@class='select2-chosen'])[1]");
    public static final Target INPUT_UNIT  = Target.the("").locatedBy("//label[text()='Unit']//following-sibling::input[@class='select2-input']");
    ...
    public static final Target INPUT_ORGANIZED_BY  = Target.the("").locatedBy("//label[text()='Organized By']//following-sibling::input[@class='select2-input']");
    ...
    public static final Target INPUT_REPORTER  = Target.the("").locatedBy("//label[text()='Reporter']//following-sibling::input[@class='select2-input']");
    ...
    public static final Target INPUT_ATTENDEE_LIST  = Target.the("").locatedBy("//div[contains(@style,'block')]//following-sibling::input[@class='select2-input']");
