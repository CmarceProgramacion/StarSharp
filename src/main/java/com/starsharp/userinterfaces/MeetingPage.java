...
public class MeetingPage extends PageObject {
    ...
    public static final Target BUTTON_DELETE_MEETING = Target.the("").locatedBy("//div[@class='tool-button delete-button icon-tool-button']");
    public static final Target BUTTON_CONFIRMS_ELIMINATION = Target.the("").locatedBy("//button[@class='btn btn-primary']");
}
