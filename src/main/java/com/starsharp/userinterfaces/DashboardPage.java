...
public class DashboardPage extends PageObject {
    ...
    public static final Target INPUT_SEARCH_BUSINESS_UNIT=Target.the("").locatedBy("//input[@class='s-Serenity-QuickSearchInput s-QuickSearchInput']");
    public static final Target ELEMENT_BUSINESS_UNIT=Target.the("").locatedBy("//a[contains(text(),'{0}')]");
